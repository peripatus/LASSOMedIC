...
function [BAlabelvol,BAnom, Vsize_new, c_new]= tmp2Atlas(template,atlas,opt)

%% adjust size and center of template to that of atlas
%
%[BAlabels,BAnom, Vsize]= MNIvol(templatefile)
% input: template ... file name of image to adjust 
%        atlas .... file name of atlas to use
...
bfile = '/Users/yu/matlab_misc/spm8/toolbox/3aal_for_spm8/ROI_MNI_V4.nii';
