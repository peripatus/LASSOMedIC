...
function [BAlabelvol,BAnom, Vsize_new, c_new]= BALvol_noCereb(template,opt)
...
%      
    ...
    vol3D = ceil(vol3D);
    % exclude cerebellum and extrapolated areas
    vol3D(vol3D > 137) =  0;
